    ...
    <div class="kt-header__topbar">
        ...
        <div class="kt-header__topbar-item dropdown">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px" aria-expanded="true">
                <span class="kt-header__topbar-icon"><i class="flaticon-suitcase"></i></span>
                ...
                <form>
                    ...
                    <div class="kt-head kt-head--skin-light kt-head--fit-x kt-head--fit-b">
                        <h3 class="kt-head__title">
                            My Wallet
                            &nbsp;
                            <span class="btn btn-label-primary btn-sm btn-bold btn-font-md">${{Auth::user()->wallet->amount}}</span>
                        </h3>
                        <br>    
                    </div>
        ...
        <div class="kt-header__topbar-item dropdown">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px" aria-expanded="true">
                <span class="kt-header__topbar-icon"><i id="notifyIcon" class="flaticon2-bell-alarm-symbol"></i></span>
                <span class="kt-hidden kt-badge kt-badge--dot kt-badge--notify kt-badge--sm"></span>
            </div>
            <div
                class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
                <form>
                    ...
                    <div class="kt-head kt-head--skin-light kt-head--fit-x kt-head--fit-b">
                        <h3 class="kt-head__title">
                            User Notifications
                            &nbsp;
                            <span id="notificationLength" class="btn btn-label-primary btn-sm btn-bold btn-font-md">23 new</span>
                        </h3>
                        <br>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active show" id="topbar_notifications_notifications" role="tabpanel">
                            <div id="notificationSec" class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll" data-scroll="true"
                    ...
                    <div class="kt-mycart">
                        <div class="kt-mycart__head kt-head" style="background-image: url({{asset('assets/media/misc/bg-1.jpg')}});">
                            ...
                            <div class="kt-mycart__button">
                                <button id="cartLength" type="button" class="btn btn-success btn-sm"></button>
                            </div>
                        </div>
                        ...
                        <div class="kt-mycart__footer">
                            <div class="kt-mycart__section">
                                ...
                                <div class="kt-mycart__prices">
                                    <span id="cart_sub_total_result"></span>
                                    <input type="hidden" id="cart_sub_total" name="cart_sub_total">
                                    <span id="cart_total_result" class="kt-font-brand"></span>
                                    <input type="hidden" id="cart_total" name="cart_total">
                                </div>
                            </div>
                            <div class="kt-mycart__button kt-align-right">
                                <a href="{{route('gold.buy.order')}}" class="btn btn-primary btn-sm">Place Order</a>
                            </div>
                        </div>
                    </div>
...
<div class="kt-header__topbar-item kt-header__topbar-item--user">
    <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
        <div class="kt-header__topbar-user">
            ...
            <span
                class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bolder">{{Auth::user()->name[0]}}</span>
        </div>
    </div>
    <div
        ...
        <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x"
            ...
            <div class="kt-user-card__avatar">
                ...
                <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                <span
                    class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success">{{Auth::user()->name[0]}}</span>
            </div>
            <div class="kt-user-card__name ">
                {{Auth::user()->name}} (Role: {{ucfirst(Auth::user()->role->name)}})
            </div>
