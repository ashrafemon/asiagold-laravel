            ...
            <div class="card border-0">
                <div class="card-body text-center">
                    <div id="registerSec" class="d-flex flex-column justify-content-center align-items-center">
                        <h2>Open Gold Account Now</h2>
                        <p>Register using your email</p>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" placeholder="User Name" value="{{ old('username') }}" required autocomplete="username" autofocus>
